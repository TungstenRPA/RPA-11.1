...
## 1️⃣Creating the Kapplets Database Tables
...
2. **Start Management Console** from Windows Start Menu/Kofax RPA.
3. Wait until you see the message *Roboserver successfully activated*.
4. Start **Design Studio** from Windows Start Menu/Kofax RPA.
5. Open any robot *type* from any robot project.
6. You can skip this next step if **objectdb.db** is already in the project.  
   <br />
...
11. Open **Tools/CreateDatabaseTable** from the Menu.  
    <br />
    > ![image](https://user-images.githubusercontent.com/47416964/101610355-6eeb5d00-3a08-11eb-824c-b76f39f29152.png)
11. Select **objectdb (Development Database)**. Select any type - it doesn't matter - and click **Generate SQL**.  
    <br />
    >![image](https://user-images.githubusercontent.com/47416964/101612429-eb7f3b00-3a0a-11eb-9822-23274735f2e8.png)
12. Delete the SQL statement that is there. *We will use this SQL window to create all the Kapplet Tables in the Development Database*.  
    <br />
    > ![image](https://user-images.githubusercontent.com/47416964/101612548-0fdb1780-3a0b-11eb-9501-3e5e322a96ca.png)
13. Open the folder **C:\Program Files\Kofax RPA 11.1.0.0 287 x64\documentation\sql\kapplets\derby** to find the sql scripts needed to create the Kapplets database.  
    <br />
    > ![image](https://user-images.githubusercontent.com/47416964/101610264-4b281700-3a08-11eb-8fed-032815e6614b.png)
14. Right-click on **create-kapplets.sql** and Open with Notepad.  
    <br />
    > ![image](https://user-images.githubusercontent.com/47416964/101623690-1d979980-3a19-11eb-96bf-6e088d37490a.png)
15. Copy the text and paste into **Generated SQL Statement** in Design Studio  
    <br />
    > ![image](https://user-images.githubusercontent.com/47416964/101623832-47e95700-3a19-11eb-9046-b9cfcb2cd598.png)
16. Copy and Paste  **create-quartz.sql** and **create-session.sql** as well into the **Generated SQL Statement** window.
17. Click the **Execute** button. The Window will close if there were no errors.  
    <br />
...
## 2️⃣Configuring the Kapplets files
...
2. Create the file **application.properties** in the kapplets Folder and give it the following content.  
   ```properties
...
5. Copy the file **C:\Program Files\Kofax RPA 11.1.0.0 287 x64\WebApps\kapplets.war** into the folder  
**C:\Program Files\Kofax RPA 11.1.0.0 287 x64\kapplets**  
6. Copy the file **C:\Program Files\Kofax RPA 11.1.0.0 287 x64\lib\thirdparty\derbyclient-10.14.2.0.jar** into the folder  
...
## 3️⃣Starting Kapplets
1. Make sure that **Start Development Database** from the Windows Menu/Kofax RPA is running.
2. Double-click the file **kapplets.bat**. *You will need to run this as a Administrator if you want the log file **logs\kapplets.log** to be created.*
3. Wait until you see the message **QuartzScheduler_$_NON_CLUSTERED started.**
4. Open Kapplets at [http://localhost:8080/kapplets](http://localhost:8080/kapplets) (case sensitive!)
